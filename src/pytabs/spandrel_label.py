...
class SpandrelLabel:
    ...
    def get_name_list(self) -> SpandrelNameList:
        ...
        spandrel_name = [str()]
        is_multi_story = [bool()]
        [ret, _number_names, spandrel_name, is_multi_story] = self.spandrel_label.GetNameList(
            _number_names, spandrel_name, is_multi_story
        )
        handle(ret)
        return {'spandrel_name': spandrel_name, 'is_multi_story': is_multi_story}
    ...
    def get_section_properties(self, spandrel_name: str) -> SectionProperties:
        ...
        [
            ...
            cg_right_y,
            cg_right_z,
        ] = self.spandrel_label.GetSectionProperties(
            spandrel_name,
            number_stories,
            story_name,
            num_area_obj,
