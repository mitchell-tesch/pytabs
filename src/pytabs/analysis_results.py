...
class AnalysisResults:
    ...
    def base_react(self) -> BaseReact:
        ...
        [
            ...
            y_coordinate,
            z_coordinate,
        ] = self.analysis_results.BaseReact(
            number_results,
            load_case,
            step_type,
            step_number,
    ...
    def base_react_with_centroid(self) -> BaseReactWithCentroid:
        ...
        ] = self.analysis_results.BaseReactWithCentroid(
            number_results,
            load_case,
            step_type,
            step_number,
    ...
    def buckling_factor(self) -> BucklingFactor:
        ...
        [ret, number_results, load_case, step_type, step_number, factor] = self.analysis_results.BucklingFactor(
            number_results, load_case, step_type, step_number, factor
        )
        handle(ret)
        return {
            'number_results': number_results,
    ...
    def frame_force(self, name, item_type_element: etabs.eItemTypeElm) -> FrameForce:
        ...
        [
            ...
            moment_2,
            moment_3,
        ] = self.analysis_results.FrameForce(
            name,
            item_type_element,
            number_results,
            object_name,
    ...
    def joint_displacement(self, name: str, item_type_element: etabs.eItemTypeElm) -> JointDisplacement:
        ...
        [
            ...
            rotation_2,
            rotation_3,
        ] = self.analysis_results.JointDispl(
            name,
            item_type_element,
            number_results,
            object_name,
    ...
    def modal_load_participation_ratios(self) -> ModalLoadParticipationRatios:
        ...
        [
            ...
            static_ratios,
            dynamic_ratios,
        ] = self.analysis_results.ModalLoadParticipationRatios(
            number_results, load_case, item_type, item, static_ratios, dynamic_ratios
        )
        handle(ret)
        return {
            'number_results': number_results,
    ...
    def modal_participating_mass_ratios(self) -> ModalParticipatingMassRatios:
        ...
        [
            ...
            sum_rotation_y,
            sum_rotation_z,
        ] = self.analysis_results.ModalParticipatingMassRatios(
            number_results,
            load_case,
            step_type,
            step_number,
    ...
    def modal_participation_factors(self) -> ModalParticipationFactors:
        ...
        [
            ...
            modal_mass,
            modal_stiff,
        ] = self.analysis_results.ModalParticipationFactors(
            number_results,
            load_case,
            step_type,
            step_number,
    ...
    def modal_period(self) -> ModalPeriod:
        ...
        [
            ...
            circular_frequency,
            eigen_value,
        ] = self.analysis_results.ModalPeriod(
            number_results,
            load_case,
            step_type,
            step_number,
    ...
    def pier_force(self) -> PierForce:
        ...
        [
            ...
            moment_2,
            moment_3,
        ] = self.analysis_results.PierForce(
            number_results,
            story_name,
            pier_name,
            load_case,
    ...
    def section_cut_analysis(self) -> SectionCutAnalysis:
        ...
        [
            ...
            moment_2,
            moment_3,
        ] = self.analysis_results.SectionCutAnalysis(
            number_results,
            section_cut,
            load_case,
            step_type,
    ...
    def spandrel_force(self) -> SpandrelForce:
        ...
        [
            ...
            moment_2,
            moment_3,
        ] = self.analysis_results.SpandrelForce(
            number_results,
            story_name,
            spandrel_name,
            load_case,
    ...
    def story_drifts(self) -> StoryDrift:
        ...
        [
            ...
            delta_y,
            delta_z,
        ] = self.analysis_results.StoryDrifts(
            number_results,
            story,
            load_case,
            step_type,
